...
from src.router_service.masstransit_consumer import MasstransitConsumer
...
class Calculator:
    ...
    #
    #
    # def fetch_coordinates(self, vehicle_id):
    #     """
    ...
    def map_to_map(self, coordinates: list):
        """
...
def run():
    ...
    """
    calculator = Calculator("Brussels, Belgium")
    consumer = MasstransitConsumer('Coordinate_Service.DTOs:PublishCoordinatesDTO', 'RouterPy', calculator.map_to_map)
    consumer.run()
